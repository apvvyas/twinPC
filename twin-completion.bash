...
_twin() {
    ...
    local cmds="route viewer run ls logs attach send kill claude cc bizdev gpu audio clip top ps pkill push pull models sh desktop kvm unlock-screen gui wake unlock off reboot status link help"
